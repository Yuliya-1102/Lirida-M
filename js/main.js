...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.certificates__slider', {
  slidesPerView: 'auto',
  slidesPerView: 2,
  spaceBetween: 30,
  loop: true,
...
const validateForms = (selector, rules, afterSend) => {
  ...
  // if (telSelector) {
  //   const inputMask = new Inputmask('+99999999999999999999');
  //   inputMask.mask(telSelector);
  // }
